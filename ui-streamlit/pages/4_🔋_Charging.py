...
# ── Scheduled Departure ────────────────────────────────────────────────────────
    ...
    with st.form("schedule_form"):
        ...
        sched_submitted = st.form_submit_button("📅 Apply Schedule", type="primary", width="stretch")
...
# ── Off-Peak Charging ──────────────────────────────────────────────────────────
    ...
    with st.form("offpeak_form"):
        ...
        op_submitted = st.form_submit_button("💾 Apply Off-Peak Settings", type="primary", width="stretch")
